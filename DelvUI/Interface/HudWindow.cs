...
namespace DelvUI.Interface {
    public abstract class HudWindow {
        ...
        protected virtual unsafe void DrawCastBar() {
            ...
            _lastPlayerUsedCast = new LastUsedCast(currentCastId, currentCastType, DataManager);
        ...
        protected virtual unsafe void DrawTargetCastBar() {
            ...
            _lastTargetUsedCast = new LastUsedCast(currentCastId, currentCastType, DataManager);
